        ...
        http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests((authorize) ->
                        authorize.requestMatchers(STATIC_RESOURCE).permitAll()
                                ...
                                .requestMatchers("/admin/users/**").hasAnyRole("ADMIN", "ADMIN_STUDENT_MANAGER")
                                .requestMatchers("/admin/courses/**").hasAnyRole("ADMIN", "ADMIN_COURSE_MANAGER")
                                ...
                                .requestMatchers("/learning/**").hasAnyRole("VIP_STUDENT", "TEACHER", "ADMIN", "MARKETING_TEAM", "ADMIN_STUDENT_MANAGER", "ADMIN_COURSE_MANAGER")
                                .requestMatchers("/Exam/**").hasAnyRole("VIP_STUDENT", "TEACHER", "ADMIN", "MARKETING_TEAM", "ADMIN_STUDENT_MANAGER", "ADMIN_COURSE_MANAGER")
                                .requestMatchers("/QuizList/course").hasAnyRole("VIP_STUDENT", "TEACHER", "ADMIN", "MARKETING_TEAM", "ADMIN_STUDENT_MANAGER", "ADMIN_COURSE_MANAGER")
