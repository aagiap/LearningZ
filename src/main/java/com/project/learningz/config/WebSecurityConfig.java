        ...
        http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests((authorize) ->
                        authorize.requestMatchers(STATIC_RESOURCE).permitAll()
                                ...
                                .requestMatchers("/admin/users/**").hasAnyRole("ADMIN", "ADMIN_USER_MANAGER")
                                ...
                                .requestMatchers("/QuizList/course").hasAnyRole("VIP_STUDENT", "TEACHER", "ADMIN", "MARKETING_TEAM", "ADMIN_USER_MANAGER", "ADMIN_COURSE_MANAGER")
